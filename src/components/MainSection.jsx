...
function MainSection() {
  return (
    <div className="text-white flex flex-col gap-10 items-center bg-[url('/src/assets/background.png')] bg-no-repeat bg-cover bg-bottom h-[867px] w-full pt-16 px-5 lg:pt-20">
